...
$LINKER --sysroot=$SYSROOT ${SYSROOT_LIB_PATH} ${OBJECT_FILE_ARGS[*]} ${LINK_OBJS[*]} ${LINK_ARGS[*]} $REQUIRED_LINKER_ARGS -z max-page-size=4096 -z common-page-size=4096 -z relro -z now
